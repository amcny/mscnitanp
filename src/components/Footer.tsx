      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <img
                src="/footer_msc.png"
                alt="Microsoft Student Chapter Logo"
                className="h-12 w-auto"
              />
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Microsoft Student Chapter at National Institute of Technology, Andhra Pradesh.
              Empowering students to become technology leaders and innovators.
            </p>
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/company/msc-nitandhra/" className="text-gray-400 hover:text-cyan-400 transition-colors">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="mailto:mlsc-nitandhra@outlook.com" className="text-gray-400 hover:text-cyan-400 transition-colors">
                <Mail className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/msc_nitandhra/" className="text-gray-400 hover:text-cyan-400 transition-colors">
        ...
        <div className="border-t border-cyan-400/20 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 Microsoft Student Chapter - NIT Andhra Pradesh. All rights reserved.
          </p>
          <p className="text-gray-400">
